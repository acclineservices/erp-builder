...
- **Decision:** Staging service configuration and online testing are external manual work. Backend/frontend are online; P010.1-B supplies the guarded one-time initial data bootstrap without claiming founder acceptance is complete.
