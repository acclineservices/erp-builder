...
class PurchaseInvoiceLine(Base):
    ...
    purchase_order_line_id: Mapped[UUID | None] = mapped_column(ForeignKey("purchase_order_lines.id", ondelete="RESTRICT"), nullable=True, index=True)
    goods_receipt_line_id: Mapped[UUID | None] = mapped_column(ForeignKey("goods_receipt_lines.id", ondelete="RESTRICT"), nullable=True, index=True)
    ...
    invoice: Mapped[PurchaseInvoice] = relationship(back_populates="lines"); item: Mapped[Item] = relationship(); purchase_order_line: Mapped[PurchaseOrderLine | None] = relationship(); goods_receipt_line: Mapped[GoodsReceiptLine | None] = relationship()
