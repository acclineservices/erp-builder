...
STANDARD_ROLE_PERMISSIONS = {
    ...
    "Accountant": frozenset(code for code in ALL_PERMISSIONS if code.startswith(("accounting.", "reports."))),
    "Sales User": frozenset(code for code in ALL_PERMISSIONS if code.startswith("sales.") and not code.endswith("approve")),
    "Purchase User": frozenset(code for code in ALL_PERMISSIONS if code.startswith("purchases.") and not code.endswith("approve")),
